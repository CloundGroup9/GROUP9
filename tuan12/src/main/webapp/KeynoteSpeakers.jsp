...
<table style="font-size: 14px; font-weight: bold;">
    <tbody>
        <tr>
            <td style="text-align: center; width: 220px;"><img alt="" src="./KeyNote_Speaker_files/RUDAS_03.JPG" style="width: 200px; height: 300px;">&nbsp;</td>
...
<table style="text-align: justify;">
    <tbody>
        <tr>
            <td style="text-align: center; width: 220px;"><img alt="" src="./KeyNote_Speaker_files/1420563224913.jpg" style="width: 200px; height: 300px;">&nbsp;</td>
            <td>
...
<br>
            ...
            <div style="margin-left: 5px">
                <img style="float: left;" src="./KeyNote_Speaker_files/tinkhac.png">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="./KeyNote_Speaker_files/Telerik.Web.UI.WebResource(1).axd" style="height:50px;width:150px;border-width:0px;display:block;">
