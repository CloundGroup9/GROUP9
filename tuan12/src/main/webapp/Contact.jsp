...
<br>
<br>
</span><iframe src="./Contact_files/embed.html" width="600" height="450" frameborder="0" style="border:0" allowfullscreen=""></iframe>
                    </div>
                </div>
                                            
            </div>
            <div style="margin-left: 5px">
                <img style="float: left;" src="./Contact_files/tinkhac.png">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="./Contact_files/Telerik.Web.UI.WebResource(1).axd" style="height:50px;width:150px;border-width:0px;display:block;">
