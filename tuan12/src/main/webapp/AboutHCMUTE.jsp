...
<body>
    ...
    <div class="display" style="float: left; width: 100%;">
        <div class="title_display">
             <a style="color:#666;" href="http://icsse2017.hcmute.edu.vn/?TopicId=e854dada-5ce1-4f57-91bf-50c720de96ef">hcmute </a> 
        </div>
        <div style="margin-top: 10px;">
            <div style="margin-left: 5px; margin-bottom: 10px;">
                <div class="ct_tin_display">
                    <div class="articleTitle">
                        <a href="http://icsse2017.hcmute.edu.vn/?ArticleId=c8018710-9562-44c6-bef0-2a0f22e73f6b"></a>
                    </div>
...
<br>
<div style="text-align: center;"><img alt="" src="./HCMUTE_files/hinh truong.jpg" style="width: 650px;"><br>
</div>
...
<span style="font-size: 14px; margin-right: auto; margin-left: auto; border-style: initial; border-color: initial; border-image-source: initial; border-image-slice: initial; border-image-width: initial; border-image-outset: initial; border-image-repeat: initial;"><img alt="" src="./HCMUTE_files/Tot nghiep.jpg" style="margin: 0px auto; padding: 0px; border: 0px; width: 670px; height: 488px; background-color: #ffffff;"></span></span>
                    </div>
                </div>
                                            
            </div>
            <div style="margin-left: 5px">
                <img style="float: left;" src="./HCMUTE_files/tinkhac.png">
                <a style="color: #0280BB; text-transform: uppercase; font: 13px Verdana; float: left; margin-left: 10px; font-weight: bold;" href="http://icsse2017.hcmute.edu.vn/ArticleId/c8018710-9562-44c6-bef0-2a0f22e73f6b/#">Others</a>
            </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="./HCMUTE_files/Telerik.Web.UI.WebResource(1).axd" style="height:50px;width:150px;border-width:0px;display:block;">
							...
							<tr>
								...
								<td class="reLeftVerticalSide" rowspan="4">&nbsp;</td><td rowspan="4" id="ctl06_ctl01_fckContentLeft" class="reTlbVertical"></td><td id="ctl06_ctl01_fckContentTop" class="reToolCell" style="width:100%;"><div class="Default reToolbarWrapper">
									<ul class="reToolbar Default" onmousedown="return false;">
										<li class="reGrip grip_first">&nbsp;</li><li><a title="Bold" class="reTool" href="http://icsse2017.hcmute.edu.vn/ArticleId/c8018710-9562-44c6-bef0-2a0f22e73f6b/#" unselectable="on"><span class="Bold" unselectable="on">&nbsp;</span></a></li><li><a title="Italic" class="reTool" href="http://icsse2017.hcmute.edu.vn/ArticleId/c8018710-9562-44c6-bef0-2a0f22e73f6b/#" unselectable="on"><span class="Italic" unselectable="on">&nbsp;</span></a></li><li><a title="Align Left" class="reTool" href="http://icsse2017.hcmute.edu.vn/ArticleId/c8018710-9562-44c6-bef0-2a0f22e73f6b/#" unselectable="on"><span class="JustifyLeft" unselectable="on">&nbsp;</span></a></li><li><a title="Align Right" class="reTool" href="http://icsse2017.hcmute.edu.vn/ArticleId/c8018710-9562-44c6-bef0-2a0f22e73f6b/#" unselectable="on"><span class="JustifyRight" unselectable="on">&nbsp;</span></a></li><li><a title="Align Center" class="reTool" href="http://icsse2017.hcmute.edu.vn/ArticleId/c8018710-9562-44c6-bef0-2a0f22e73f6b/#" unselectable="on"><span class="JustifyCenter" unselectable="on">&nbsp;</span></a></li><li><a title="Justify" class="reTool" href="http://icsse2017.hcmute.edu.vn/ArticleId/c8018710-9562-44c6-bef0-2a0f22e73f6b/#" unselectable="on"><span class="JustifyFull" unselectable="on">&nbsp;</span></a></li><li class="reGrip grip_last">&nbsp;</li>
									</ul>
								</div></td><td rowspan="4" id="ctl06_ctl01_fckContentRight" class="reTlbVertical"></td><td rowspan="4" class="reRightVerticalSide">&nbsp;</td>
							</tr><tr>
								<td valign="top" id="ctl06_ctl01_fckContentCenter" class="reContentCell" style="height:100%;"><label for="ctl06_ctl01_fckContentContentHiddenTextarea" style="display:none;">RadEditor hidden textarea</label><textarea id="ctl06_ctl01_fckContentContentHiddenTextarea" name="ctl06$ctl01$fckContent" rows="4" cols="20" style="display:none;"></textarea><iframe frameborder="0" src="javascript:&#39;&lt;html&gt;&lt;/html&gt;&#39;;" title="Rich text editor with ID ctl06_ctl01_fckContent" id="ctl06_ctl01_fckContent_contentIframe" style="width: 100%; height: 100%; margin: 0px; padding: 0px;" src="./HCMUTE_files/saved_resource.html">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe></td>
							</tr><tr>
